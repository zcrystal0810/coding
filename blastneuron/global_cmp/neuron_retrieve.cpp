...
// create excel
    QString excel_name = "/home/penglab/Desktop/sujun/GAN/release_workingspace/1000_blast/800/1.txt";
    ofstream file;
    file.open (excel_name.toStdString().c_str(),ios::out | ios::app );
    for (int i=0; i<neuronNum-1; i++){
        file<<rank_sum[i]<<",";
    }
    file<<rank_sum[neuronNum-1]<<endl;
    file.close();
